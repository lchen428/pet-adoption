...
LOGIN_ERROR_URL = '/adowner/'

SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = os.env.get('SOCIAL_AUTH_GOOGLE_OAUTH2_KEY')
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = os.env.get('SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET')
